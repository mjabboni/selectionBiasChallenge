...
axes[0, 0].set_title('Reality', fontsize=14, fontweight='bold')
axes[0, 0].axis('off')

# Stippled Image (Your Model)
axes[0, 1].imshow(stipple_pattern, cmap='gray')
axes[0, 1].set_title('Your Model', fontsize=14, fontweight='bold')
axes[0, 1].axis('off')

# Block Letter (Selection Bias Pattern)
axes[1, 0].imshow(block_letter, cmap='gray')
axes[1, 0].set_title('Selection Bias (S)', fontsize=14, fontweight='bold')
axes[1, 0].axis('off')

# Masked Stipple (Biased Estimate)
axes[1, 1].imshow(masked_stipple, cmap='gray')
axes[1, 1].set_title('Biased Estimate', fontsize=14, fontweight='bold')
axes[1, 1].axis('off')
...
The key lesson: **If you can't see the full picture, you might be seeing a completely different pattern than what actually exists.**
