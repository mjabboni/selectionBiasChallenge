...
axes[0, 0].set_title('Reality', fontsize=6, fontweight='bold')
axes[0, 0].axis('off')

# Stippled Image (Your Model)
axes[0, 1].imshow(stipple_pattern, cmap='gray')
axes[0, 1].set_title('Your Model', fontsize=6, fontweight='bold')
axes[0, 1].axis('off')

# Block Letter (Selection Bias Pattern)
axes[0, 2].imshow(block_letter, cmap='gray')
axes[0, 2].set_title('Selection\n Bias (S)', fontsize=6, fontweight='bold')
axes[0, 2].axis('off')

# Masked Stipple (Biased Estimate)
axes[0, 3].imshow(masked_stipple, cmap='gray')
axes[0, 3].set_title('Biased\n Estimate', fontsize=6, fontweight='bold')
axes[0, 3].axis('off')
